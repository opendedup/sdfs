...
public interface MetaFileEventListener {
	...
	void onExecutableChange(boolean executable, boolean ownerOnly,
			MetaDataDedupFile mf);

	void onWritabeChange(boolean writable, boolean ownerOnly,
			MetaDataDedupFile mf);
	...
	void onReadableChange(boolean readable, boolean ownerOnly,
			MetaDataDedupFile mf);
	...
	void onSnapshotExecuted(String snaptoPath, boolean overwrite,
