 ...
 *         files into memory.
 */
public class VariableDedupChunk implements java.io.Serializable {
	...
	public VariableDedupChunk(long position) {
	 ...
	 */
	public VariableDedupChunk(byte[] hash, long position, int length, boolean newChunk) {
		this.hash = hash;
		this.length = length;
		this.position = position;
	 ...
	 *            The length of the chunk
	 */
	public VariableDedupChunk(byte[] hash, byte[] data, long position, int length) {
		this.hash = hash;
		this.data = data;
		this.length = length;
		this.position = position;
