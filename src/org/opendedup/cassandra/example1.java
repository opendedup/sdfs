...
public class example1 {
    ...
    static String[] CONTACT_POINTS = {"192.168.56.101"};
    ...
    public void createSchema() {
        ...
        session.execute("CREATE KEYSPACE IF NOT EXISTS "+ Main.volume.getUuid() +" WITH replication " +
                "= {'class':'SimpleStrategy', 'replication_factor':"+Main.volume.getClusterCopies()+ "};");
