...
public class ObjectList {
	...
	public static Object FREE = null;
	public static Object REMOVED = null;
	private int iterPos = 0;

	public ObjectList(int size, short arraySize) throws IOException {
		this.size = size;
		this.setUp();
	}
	...
	public Object remove(byte[] key) throws IOException {
		try {
			this.hashlock.writeLock().lock();
			int pos = this.index(key);
			if (pos == -1) {
	...
	public static void main(String[] args) throws Exception {
		ObjectList b = new ObjectList(1000000, (short) 16);
