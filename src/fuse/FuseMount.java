...
public class FuseMount {
	...
	public static void mount(String[] args, Filesystem1 filesystem1)
		...
		mount(args, new Filesystem2ToFilesystem3Adapter(
				new Filesystem1ToFilesystem2Adapter(filesystem1)), LogFactory
				.getLog(filesystem1.getClass()));
	}

	public static void mount(String[] args, Filesystem2 filesystem2)
			throws Exception {
		mount(args, new Filesystem2ToFilesystem3Adapter(filesystem2),
				LogFactory.getLog(filesystem2.getClass()));
	}

	//
	// prefered String level API

	public static void mount(String[] args, Filesystem3 filesystem3, Log log)
			throws Exception {
	...
	public static void mount(String[] args, FuseFS fuseFS) throws Exception {
		...
		if (log.isDebugEnabled()) {
			...
			log.debug("ThreadGroup(\"" + threadGroup.getName()
					+ "\").activeCount() = " + n);
