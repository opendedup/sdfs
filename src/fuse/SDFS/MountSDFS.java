...
public class MountSDFS {
	...
	public static Options buildOptions() {
		...
		options.addOption("r", true, "path to chunkstore routing file. \n Will default to: \n/etc/sdfs/routing-config.xml");
	...
	private static void printHelp(Options options) {
		...
		formatter.printHelp( "mount.sdfs -f -o <fuse options> -m <mount point> " +
				"-r <path to chunk store routing file> -[v|vc] <volume name to mount | path to volume config file> ", options );
	}
