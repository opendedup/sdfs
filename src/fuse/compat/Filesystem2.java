 ...
 * fuse.FuseException with a errno field of the exception set to the desired
 * value.
 * 
...
public interface Filesystem2 extends FilesystemConstants {
	...
	// CHANGE-22: if open returns a filehandle it is passed to every other
	// filesystem call
	...
	// CHANGE-22: new operation (called on every filehandle close), fh is
	// filehandle passed from open
	public void flush(String path, long fh) throws FuseException;

	// CHANGE-22: (called when last filehandle is closed), fh is filehandle
	// passed from open
	public void release(String path, long fh, int flags) throws FuseException;

	// CHANGE-22: new operation (Synchronize file contents), fh is filehandle
	// passed from open,
