...
public interface XattrSupport {
	 ...
	 *            the name of the extended attribute
	 * @param position
	 *            specifies the offset within the extended attribute. In the
	 *            current implementation, only the resource fork extended
	 *            attribute makes use of this argument. For all others, position
