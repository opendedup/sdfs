...
;Version Information
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "3.6.0.6"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "3.6.0.6"
;--------------------------------
;Installer Sections
