...
;Languages
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "3.7.6.0"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "3.7.6.0"
;--------------------------------
;Installer Sections
