...
;Version Information
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "3.5.8.1"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "3.5.8.1"
;--------------------------------
;Installer Sections
