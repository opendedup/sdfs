...
;Version Information
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "3.5.9.1"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "3.5.9.1"
;--------------------------------
;Installer Sections
