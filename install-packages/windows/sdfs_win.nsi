...
;Languages
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "3.7.7.3"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "3.7.7.3"
;--------------------------------
;Installer Sections
