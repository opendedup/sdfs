...
;Version Information
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "3.5.4.0"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "3.5.4.0"
;--------------------------------
;Installer Sections
