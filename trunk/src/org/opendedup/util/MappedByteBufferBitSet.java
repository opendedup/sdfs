...
public class MappedByteBufferBitSet implements Cloneable, java.io.Serializable {
    ...
    private long getWord(int arrayPos) {
    	...
    	return this.buf.getLong(pos);
    		...
    		System.out.println("unable to get " + pos + " buf cap = " +this.buf.capacity());
    		return 0;
    	}
    }
     ...
     *         is negative
     */
    public MappedByteBufferBitSet(String fileName,int nbits) throws IOException {
    ...
    */
    ...
    public int length() {
        ...
        return BITS_PER_WORD * (wordsInUse - 1) +
            (BITS_PER_WORD - Long.numberOfLeadingZeros(this.getWord(wordsInUse - 1)));
    }
    ...
    public static void main(String [] args) throws IOException {
    	MappedByteBufferBitSet bs = new MappedByteBufferBitSet("/home/annesam/test.map");
