...
public class S3ChunkStoreUtils {
	...
	public static Options buildOptions() {
		...
		options
				.addOption(OptionBuilder
						.withLongOpt("delete-bucket")
						.withDescription(
								"Delete a  non-empty S3 bucket")
	...
	public static void parseCmdLine(String[] args) throws Exception {
		...
		if(cmd.hasOption("delete-bucket")) {
			...
			S3ChunkStore.deleteBucket(cmd.getOptionValue("delete-bucket"), cmd.getOptionValue("aws-access-key"), cmd.getOptionValue("aws-secret-key"));
		}
	}
