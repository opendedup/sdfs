...
public class FuseStatfs extends Struct implements FuseStatfsSetter {
	...
	protected boolean appendAttributes(StringBuilder buff, boolean isPrefixed) {
		...
		buff.append("blockSize=").append(blockSize).append(", blocks=")
				.append(blocks).append(", blocksFree=").append(blocksFree)
				.append(", blocksAvail=").append(blocksAvail)
				.append(", files=").append(files).append(", filesFree=")
				.append(filesFree).append(", namelen=").append(namelen);
